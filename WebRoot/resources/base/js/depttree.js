...
{   
    ...
    //定义图标显示用数组
	this.icon=new Array();
	this.icon["member"]=Bonc.getContextPath()+'/resources/app/img/child.gif';
	this.icon["open"]=Bonc.getContextPath()+'/resources/app/img/opened.gif';
	this.icon["close"]=Bonc.getContextPath()+'/resources/app/img/closed.gif';	
	this.icon["root"]=Bonc.getContextPath()+'/resources/app/img/folder.gif';
...
//当长度过长换行输出
 ...
 document.write('<div id="TreePanel" style="position: absolute;display: none;z-index: 9999;background-color: #FFFFFF;border: 1px solid #CCCCCC;width:250px;height:330px;overflow-y: scroll;font-size:12px;"></div>');
   if(document.all)
   {
	   ...
	   document.write('display:expression(this.previousSibling.style.display);" scrolling="no" frameborder="1"></iframe>');
   }
