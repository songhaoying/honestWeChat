...
Calendar.prototype.draw = function() {
  ...
  mvAry[mvAry.length]  = '        <th align="center" width="98%" nowrap="nowrap"><select name="calendarYear" id="calendarYear" style="font-size:11px;"></select><select name="calendarMonth" id="calendarMonth" style="font-size:11px;"></select></th>';
...
document.write('background-color: #FFFFFF;border: 1px solid #CCCCCC;width:175px;font-size:11px;"></div>');
if(document.all)
{
