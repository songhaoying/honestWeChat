...
<body>
	...
	<div class="center" style="height: 440px;">
		<table id="mytable" cellspacing="1">
			...
			<tr>
				<td colspan="4" style="height: 150px;"><textarea id="PLAN_INFO" style="height: 150px; width: 685px;"></textarea></td>
			</tr>
			<tr style="border: 0px;">
				<td style="border: 0px; height: 25px;"></td>
				<td style="border: 0px; height: 25px;"><input onclick="save();" type="button" style="height: 25px; float: right; background-color: #CAE8EA; width: 80px;" value="  发  布  "></td>
