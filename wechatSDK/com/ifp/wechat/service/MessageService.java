...
public class MessageService {
	...
	static {
		...
		bulidMessageMap.put(ConstantWeChat.RESP_MESSAGE_TYPE_CUSTOMER_SERVICE, new TransferCustomerServiceMessage());
	}
	 ...
	 * @return BaseMessage 基本消息对象
	 */
	public static Object bulidCustomerServiceMessage(Map<String, String> requestMap,
			String msgType) {
		// 发送方帐号（open_id）
		String fromUserName = requestMap.get("FromUserName");
		// 公众帐号
...
//			// 多客服接入消息
//			if(msgType==ConstantWeChat.RESP_MESSAGE_TYPE_CUSTOMER_SERVICE){
//			// TODO 多客服接入消息
