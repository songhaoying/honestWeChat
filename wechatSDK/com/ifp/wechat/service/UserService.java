...
public class UserService {
	...
	public static void main(String[] args) {
		// UserWeiXin user;
	//List<UserWeiXin> users = getUserList();
//		for (UserWeiXin user : users) {
//			System.out.println(user.getNickname() + "," + user.getOpenid());
//		}
		getUserOpenIdList();
		
		String token = WeixinUtil.getToken();
		String url = GET_USER_INFO.replace("ACCESS_TOKEN", token).replace("OPENID", "o53-7jn3TqxZ7MK7LUFG3IeaSySg");
		JSONObject jsonObject = WeixinUtil.httpsRequest(url, "POST", null);
		System.out.println(jsonObject.toString());
//		 UserWeiXin user=getUserInfo("o53-7jn3TqxZ7MK7LUFG3IeaSySg");
