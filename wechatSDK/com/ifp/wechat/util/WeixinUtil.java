...
public class WeixinUtil {
	 ...
	 * 百度翻译的api url
	 */
	public final static String BAIDU_TRANS_URL = "https://openapi.baidu.com/public/2.0/bmt/translate?client_id=YourApiKey&q=SRC&from=auto&to=auto";
	//2016.01.26 更新为百度的新API
	//public final static String BAIDU_TRANS_URL = "https://openapi.baidu.com/public/2.0/bmt/translate?client_id=YourApiKey&q=SRC&from=auto&to=auto";
	...
	public static AccessToken getAccessToken(String appid, String appsecret) {
		...
		if (null != jsonObject) {
			try {
				...
				ConstantWeChat.setAccessToken(accessToken.getToken());
	 ...
	 */
	public static String transMessage(String SRC) throws UnsupportedEncodingException {
		StringBuilder sb = new StringBuilder();
		 

		String requestUrl = BAIDU_TRANS_URL.replace("YourApiKey", ConstantWeChat.BAIDU_API_KEY).replace("SRC", URLEncoder.encode( SRC,"UTF-8"));
		JSONObject jsonObject = httpsRequest(requestUrl, "GET", null);
		// 如果请求成功
		if (null != jsonObject) {
			try {
...
//		String url="";
//		try {
//			url = BAIDU_TRANS_URL.replace("YourApiKey", ConstantWeChat.BAIDU_API_KEY).replace("SRC", URLEncoder.encode( "I am Chinese","UTF-8"));
...
//		method.releaseConnection();
		...
		try {
			...
			System.out.println(transMessage("我是中国人。\n 你他妈可以去死了。"));
