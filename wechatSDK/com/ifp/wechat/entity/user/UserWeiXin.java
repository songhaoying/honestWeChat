...
public class UserWeiXin {
	...
	public String toString() {
		String tmp = "";
		tmp += "openId:" + this.openid + ", nickName:" + this.nickname
				+ ", 国家:" + this.country + ", 用户所在城市city:" + this.city
				+ ", 微信特权privilege:" + this.privilege + ", 所在省分province:"
				+ this.province + "" + this.language + ", 头像："
				+ this.headimgurl+",  关注时间"+this.subscribe_time;
		return tmp;
	}
}
